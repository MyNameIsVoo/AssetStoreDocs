...
Before viewing the documentation, [please review the basic configuration](https://github.com/MyNameIsVoo/AssetStoreDocs/tree/main/FactoryGameBuildings).

![Unity](https://img.shields.io/badge/unity-%23000000.svg?style=for-the-badge&logo=unity&logoColor=white)

![Start Image](images/CardImage_420x280.png)

Find the asset on Unity
- Base [Asset Store](https://u3d.as/3uQX)
- Enhanced Edition [Asset Store](https://u3d.as/3uU7)
...
**Features:**
- Everything included in the base edition
- Animations
- Effects
- Icons
- Top view icons
