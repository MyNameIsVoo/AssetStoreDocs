...
Find the asset on Unity [Asset Store](https://u3d.as/3vXU).
...
[![YouTube](https://img.shields.io/badge/Watch_Video-YouTube-%23FF0000.svg?style=for-the-badge&logo=YouTube&logoColor=white)](https://youtu.be/j21akYLI7Uk?si=GX0WdIl_jFzhng53)
...
This tool is an add-on (extension) to the [Hexagonal Grid System](https://assetstore.unity.com/packages/tools/modeling/hexasphere-grid-system-89112) tool. It works out of the box and is ready to be integrated into your game.

**Features:**

- Ready-made system for generating a hexagonal planet of different sizes
- Fast generation of planets (larger sizes will take longer to generate)
- 13 biomes (Desert, Savanna, Tropical rainforest, Grassland, Woodland, Seasonal forest, Temperate rainforest, Boreal forest, Tundra, Ice, Deep water, Shallow water, River)
- High quality textures (1024x1024 (must be downloaded separately, the link is in the redmi file) and 512x512, *.png).
- 4 maps (Biome, Heat, Moisture, Hight)
- Example scene
- Fast generation
- Tile system that carries all the information about the tile

![Start Image](images/Screenshot_1.png)

![Start Image](images/Screenshot_2.png)

![Start Image](images/Screenshot_3.png)

![Start Image](images/Screenshot_4.png)

![Start Image](images/Screenshot_5.png)

![Start Image](images/Gif_02.gif)
...
- [Hexasphere Grid System](https://assetstore.unity.com/packages/tools/modeling/hexasphere-grid-system-89112)
- https://habr.com/ru/post/276281/