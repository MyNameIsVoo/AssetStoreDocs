...
![Start Image](https://cdna.artstation.com/p/assets/images/images/046/009/934/large/sam-erochin-img-026.jpg?1644082247)
...
Find the asset on Unity [Asset Store](https://u3d.as/3ybY).
If you need the character weapons (or tools) you can find them here: [Factory Game Tools](https://u3d.as/3v8M)
If you need Factory Buildings you can find them here: [Asset Store](https://u3d.as/3yfS)
...
High quality, low poly space shuttle model "Fly" in the style of science and the future.
Themes of the shuttle: future, production, factory, alien technologies, sci-fi, science, robot
You can achieve amazing results using **URP** *(primary pipeline)* or **HDRP**. See screenshots from the game!

**Features:**
- VFX rocket effect
- Low-poly: total 9k vertices
- High quality textures (2048x2048, *.png)
- Normal Map, AlbedoTransparency, Emission, MetallicSmoothness
- 2 Icons

![Start Image](images/Screenshot_3.jpg)

![Start Image](images/Screenshot_8.jpg)

> This asset contains shuttle model, textures, materials, icons. The [cargo](https://assetstore.unity.com/packages/3d/props/industrial/factory-game-buildings-313653) does not included!
...
![Start Image](images/05_TradingFloor.gif)
...
- ![Unity](https://img.shields.io/badge/BuildIn-000.svg) - the VFXs will not works correctly
